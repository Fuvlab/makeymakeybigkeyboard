...
int keyCodes[NUM_INPUTS] = {
  ...
  ////// note: for fr keyboard but MakeyMakey use US keymap
  ////// sound control keys below

  'w',         // up arrow pad (w instead of z for azerty keyboard mismatch)
  'e',         // down arrow pad
  't',         // left arrow pad
  'y',         // right arrow pad
  'u',         // space button pad
  ...
  ///// note keys below
  'a',                // pin D5 (a instead of q for azerty keyboard mismatch)
  's',                // pin D4
  'd',                // pin D3
  'f',                // pin D2
  'g',                // pin D1
  ...
  'k',    // pin A4
  'l',    // pin A3
  ';',    // pin A2 (; instead of m for azerty keyboard mismatch)
  'p',    // pin A1
